...
def training_loop(
    ...
    resume_pkl              = '/app/results/00000-stylegan2-smalls-1gpu-config-f/network-snapshot-004752.pkl',     # Network pickle to resume training from, None = train from scratch.
